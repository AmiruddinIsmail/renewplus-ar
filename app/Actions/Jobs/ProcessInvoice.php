...
class ProcessInvoice
{
    ...
    */
    ...
    if($today->isEndOfMonth()){
        if($today->day == 28) $selectedDays = array_merge($selectedDays, [29,30,31]);
        if($today->day == 29) $selectedDays =  array_merge($selectedDays, [30,31]);
        if($today->day == 30) $selectedDays =  array_merge($selectedDays, [31]);
    }
